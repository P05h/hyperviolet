                ...
                return ["document", "iframe"].includes(i.destination) ? (console.error(e), function(e, t, r) {
                    ...
                    return new Response(function(e, t, r, i, s, o, n) {
                        if ("The specified host could not be resolved." === i) return function(e, t) {
                            const r = new URL(e),
                                i = `remoteHostname.textContent = ${JSON.stringify(r.hostname)};bareServer.href = ${JSON.stringify(t)};uvHostname.textContent = ${JSON.stringify(location.hostname)};reload.addEventListener("click", () => location.reload());uvVersion.textContent = ${JSON.stringify("1.0.10")};`;
